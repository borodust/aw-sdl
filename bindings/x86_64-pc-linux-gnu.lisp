...
(defparameter %sdl::+filesystem-dummy+ 1)
...
(defparameter %sdl::+haptic-disabled+ 1)
...
(defparameter %sdl::+joystick-disabled+ 1)

(defparameter %sdl::+lil-endian+ 1234)

(defparameter %sdl::+line+ 470)

(defparameter %sdl::+loadso-disabled+ 1)
...
(defparameter %sdl::+sensor-disabled+ 1)
...
(defparameter %sdl::+threads-disabled+ 1)

(defparameter %sdl::+timers-disabled+ 1)
...
(defparameter %sdl::+config-minimal-h-+ nil)
...
(cffi:defctype %sdl::audio-filter (:pointer :void))
...
(cffi:defcfun ("__claw_SDL_LogMessageV" %sdl::log-message-v)
              :void
              (%sdl::category :int)
              (%sdl::priority %sdl::log-priority)
              (%sdl::fmt claw-utils:claw-string)
              (%sdl::ap (:pointer %sdl::va-list)))
...
(cffi:defcfun ("__claw_SDL_vsnprintf" %sdl::vsnprintf)
              :int
              (%sdl::text claw-utils:claw-string)
              (%sdl::maxlen %sdl::size-t)
              (%sdl::fmt claw-utils:claw-string)
...
(cffi:defcfun ("__claw_SDL_vsscanf" %sdl::vsscanf)
              :int
              (%sdl::text claw-utils:claw-string)
              (%sdl::fmt claw-utils:claw-string)
              (%sdl::ap (:pointer %sdl::va-list)))
...
(cffi:defcfun ("SDL_AssertData" %sdl::assert-data) :void)

(cffi:defcfun ("~SDL_AssertData"
               %sdl::sdl-assert-data+~sdl-assert-data)
              :void)

(cffi:defcfun ("SDL_AudioCVT" %sdl::audio-cvt) :void)

(cffi:defcfun ("~SDL_AudioCVT" %sdl::sdl-audio-cvt+~sdl-audio-cvt)
              :void)

(cffi:defcfun ("SDL_AudioDeviceEvent" %sdl::audio-device-event) :void)

(cffi:defcfun ("~SDL_AudioDeviceEvent"
               %sdl::sdl-audio-device-event+~sdl-audio-device-event)
              :void)

(cffi:defcfun ("SDL_AudioSpec" %sdl::audio-spec) :void)

(cffi:defcfun ("~SDL_AudioSpec" %sdl::sdl-audio-spec+~sdl-audio-spec)
              :void)

(cffi:defcfun ("SDL_Color" %sdl::color) :void)

(cffi:defcfun ("~SDL_Color" %sdl::sdl-color+~sdl-color) :void)

(cffi:defcfun ("SDL_CommonEvent" %sdl::common-event) :void)

(cffi:defcfun ("~SDL_CommonEvent"
               %sdl::sdl-common-event+~sdl-common-event)
              :void)

(cffi:defcfun ("SDL_ControllerAxisEvent" %sdl::controller-axis-event)
              :void)

(cffi:defcfun ("~SDL_ControllerAxisEvent"
               %sdl::sdl-controller-axis-event+~sdl-controller-axis-event)
              :void)

(cffi:defcfun ("SDL_ControllerButtonEvent"
               %sdl::controller-button-event)
              :void)

(cffi:defcfun ("~SDL_ControllerButtonEvent"
               %sdl::sdl-controller-button-event+~sdl-controller-button-event)
              :void)

(cffi:defcfun ("SDL_ControllerDeviceEvent"
               %sdl::controller-device-event)
              :void)

(cffi:defcfun ("~SDL_ControllerDeviceEvent"
               %sdl::sdl-controller-device-event+~sdl-controller-device-event)
              :void)

(cffi:defcfun ("SDL_ControllerSensorEvent"
               %sdl::controller-sensor-event)
              :void)

(cffi:defcfun ("~SDL_ControllerSensorEvent"
               %sdl::sdl-controller-sensor-event+~sdl-controller-sensor-event)
              :void)

(cffi:defcfun ("SDL_ControllerTouchpadEvent"
               %sdl::controller-touchpad-event)
              :void)

(cffi:defcfun ("~SDL_ControllerTouchpadEvent"
               %sdl::sdl-controller-touchpad-event+~sdl-controller-touchpad-event)
              :void)

(cffi:defcfun ("SDL_DisplayEvent" %sdl::display-event) :void)

(cffi:defcfun ("~SDL_DisplayEvent"
               %sdl::sdl-display-event+~sdl-display-event)
              :void)

(cffi:defcfun ("SDL_DollarGestureEvent" %sdl::dollar-gesture-event)
              :void)

(cffi:defcfun ("~SDL_DollarGestureEvent"
               %sdl::sdl-dollar-gesture-event+~sdl-dollar-gesture-event)
              :void)

(cffi:defcfun ("SDL_DropEvent" %sdl::drop-event) :void)

(cffi:defcfun ("~SDL_DropEvent" %sdl::sdl-drop-event+~sdl-drop-event)
              :void)

(cffi:defcfun ("SDL_FPoint" %sdl::f-point) :void)

(cffi:defcfun ("~SDL_FPoint" %sdl::sdl-f-point+~sdl-f-point) :void)

(cffi:defcfun ("SDL_FRect" %sdl::f-rect) :void)

(cffi:defcfun ("~SDL_FRect" %sdl::sdl-f-rect+~sdl-f-rect) :void)

(cffi:defcfun ("SDL_Finger" %sdl::finger) :void)

(cffi:defcfun ("~SDL_Finger" %sdl::sdl-finger+~sdl-finger) :void)

(cffi:defcfun ("SDL_GameControllerButtonBind"
               %sdl::game-controller-button-bind)
              :void)

(cffi:defcfun ("~SDL_GameControllerButtonBind"
               %sdl::sdl-game-controller-button-bind+~sdl-game-controller-button-bind)
              :void)

(cffi:defcfun ("SDL_HapticCondition" %sdl::haptic-condition) :void)

(cffi:defcfun ("~SDL_HapticCondition"
               %sdl::sdl-haptic-condition+~sdl-haptic-condition)
              :void)

(cffi:defcfun ("SDL_HapticConstant" %sdl::haptic-constant) :void)

(cffi:defcfun ("~SDL_HapticConstant"
               %sdl::sdl-haptic-constant+~sdl-haptic-constant)
              :void)

(cffi:defcfun ("SDL_HapticCustom" %sdl::haptic-custom) :void)

(cffi:defcfun ("~SDL_HapticCustom"
               %sdl::sdl-haptic-custom+~sdl-haptic-custom)
              :void)

(cffi:defcfun ("SDL_HapticDirection" %sdl::haptic-direction) :void)

(cffi:defcfun ("~SDL_HapticDirection"
               %sdl::sdl-haptic-direction+~sdl-haptic-direction)
              :void)

(cffi:defcfun ("SDL_HapticLeftRight" %sdl::haptic-left-right) :void)

(cffi:defcfun ("~SDL_HapticLeftRight"
               %sdl::sdl-haptic-left-right+~sdl-haptic-left-right)
              :void)

(cffi:defcfun ("SDL_HapticPeriodic" %sdl::haptic-periodic) :void)

(cffi:defcfun ("~SDL_HapticPeriodic"
               %sdl::sdl-haptic-periodic+~sdl-haptic-periodic)
              :void)

(cffi:defcfun ("SDL_HapticRamp" %sdl::haptic-ramp) :void)

(cffi:defcfun ("~SDL_HapticRamp"
               %sdl::sdl-haptic-ramp+~sdl-haptic-ramp)
              :void)

(cffi:defcfun ("SDL_JoyAxisEvent" %sdl::joy-axis-event) :void)

(cffi:defcfun ("~SDL_JoyAxisEvent"
               %sdl::sdl-joy-axis-event+~sdl-joy-axis-event)
              :void)

(cffi:defcfun ("SDL_JoyBallEvent" %sdl::joy-ball-event) :void)

(cffi:defcfun ("~SDL_JoyBallEvent"
               %sdl::sdl-joy-ball-event+~sdl-joy-ball-event)
              :void)

(cffi:defcfun ("SDL_JoyButtonEvent" %sdl::joy-button-event) :void)

(cffi:defcfun ("~SDL_JoyButtonEvent"
               %sdl::sdl-joy-button-event+~sdl-joy-button-event)
              :void)

(cffi:defcfun ("SDL_JoyDeviceEvent" %sdl::joy-device-event) :void)

(cffi:defcfun ("~SDL_JoyDeviceEvent"
               %sdl::sdl-joy-device-event+~sdl-joy-device-event)
              :void)

(cffi:defcfun ("SDL_JoyHatEvent" %sdl::joy-hat-event) :void)

(cffi:defcfun ("~SDL_JoyHatEvent"
               %sdl::sdl-joy-hat-event+~sdl-joy-hat-event)
              :void)

(cffi:defcfun ("SDL_KeyboardEvent" %sdl::keyboard-event) :void)

(cffi:defcfun ("~SDL_KeyboardEvent"
               %sdl::sdl-keyboard-event+~sdl-keyboard-event)
              :void)

(cffi:defcfun ("SDL_Keysym" %sdl::keysym) :void)

(cffi:defcfun ("~SDL_Keysym" %sdl::sdl-keysym+~sdl-keysym) :void)

(cffi:defcfun ("SDL_Locale" %sdl::locale) :void)

(cffi:defcfun ("~SDL_Locale" %sdl::sdl-locale+~sdl-locale) :void)

(cffi:defcfun ("SDL_MouseButtonEvent" %sdl::mouse-button-event) :void)

(cffi:defcfun ("~SDL_MouseButtonEvent"
               %sdl::sdl-mouse-button-event+~sdl-mouse-button-event)
              :void)

(cffi:defcfun ("SDL_MouseMotionEvent" %sdl::mouse-motion-event) :void)

(cffi:defcfun ("~SDL_MouseMotionEvent"
               %sdl::sdl-mouse-motion-event+~sdl-mouse-motion-event)
              :void)

(cffi:defcfun ("SDL_MouseWheelEvent" %sdl::mouse-wheel-event) :void)

(cffi:defcfun ("~SDL_MouseWheelEvent"
               %sdl::sdl-mouse-wheel-event+~sdl-mouse-wheel-event)
              :void)

(cffi:defcfun ("SDL_MultiGestureEvent" %sdl::multi-gesture-event)
              :void)

(cffi:defcfun ("~SDL_MultiGestureEvent"
               %sdl::sdl-multi-gesture-event+~sdl-multi-gesture-event)
              :void)
...
(cffi:defcfun ("SDL_OSEvent" %sdl::os-event) :void)

(cffi:defcfun ("~SDL_OSEvent" %sdl::sdl-os-event+~sdl-os-event) :void)

(cffi:defcfun ("SDL_Palette" %sdl::palette) :void)

(cffi:defcfun ("~SDL_Palette" %sdl::sdl-palette+~sdl-palette) :void)

(cffi:defcfun ("SDL_PixelFormat" %sdl::pixel-format) :void)

(cffi:defcfun ("~SDL_PixelFormat"
               %sdl::sdl-pixel-format+~sdl-pixel-format)
              :void)

(cffi:defcfun ("SDL_Point" %sdl::point) :void)

(cffi:defcfun ("~SDL_Point" %sdl::sdl-point+~sdl-point) :void)

(cffi:defcfun ("SDL_QuitEvent" %sdl::quit-event) :void)

(cffi:defcfun ("~SDL_QuitEvent" %sdl::sdl-quit-event+~sdl-quit-event)
              :void)

(cffi:defcfun ("SDL_RWops" %sdl::r-wops) :void)

(cffi:defcfun ("~SDL_RWops" %sdl::sdl-r-wops+~sdl-r-wops) :void)

(cffi:defcfun ("SDL_Rect" %sdl::rect) :void)

(cffi:defcfun ("~SDL_Rect" %sdl::sdl-rect+~sdl-rect) :void)

(cffi:defcfun ("SDL_RendererInfo" %sdl::renderer-info) :void)

(cffi:defcfun ("~SDL_RendererInfo"
               %sdl::sdl-renderer-info+~sdl-renderer-info)
              :void)

(cffi:defcfun ("SDL_SensorEvent" %sdl::sensor-event) :void)

(cffi:defcfun ("~SDL_SensorEvent"
               %sdl::sdl-sensor-event+~sdl-sensor-event)
              :void)

(cffi:defcfun ("SDL_Surface" %sdl::surface) :void)

(cffi:defcfun ("~SDL_Surface" %sdl::sdl-surface+~sdl-surface) :void)

(cffi:defcfun ("SDL_SysWMEvent" %sdl::sys-wm-event) :void)

(cffi:defcfun ("~SDL_SysWMEvent"
               %sdl::sdl-sys-wm-event+~sdl-sys-wm-event)
              :void)

(cffi:defcfun ("SDL_SysWMinfo" %sdl::sys-w-minfo) :void)

(cffi:defcfun ("~SDL_SysWMinfo"
               %sdl::sdl-sys-w-minfo+~sdl-sys-w-minfo)
              :void)

(cffi:defcfun ("SDL_SysWMmsg" %sdl::sys-w-mmsg) :void)

(cffi:defcfun ("~SDL_SysWMmsg" %sdl::sdl-sys-w-mmsg+~sdl-sys-w-mmsg)
              :void)

(cffi:defcfun ("SDL_TextEditingEvent" %sdl::text-editing-event) :void)

(cffi:defcfun ("~SDL_TextEditingEvent"
               %sdl::sdl-text-editing-event+~sdl-text-editing-event)
              :void)

(cffi:defcfun ("SDL_TextInputEvent" %sdl::text-input-event) :void)

(cffi:defcfun ("~SDL_TextInputEvent"
               %sdl::sdl-text-input-event+~sdl-text-input-event)
              :void)

(cffi:defcfun ("SDL_TouchFingerEvent" %sdl::touch-finger-event) :void)

(cffi:defcfun ("~SDL_TouchFingerEvent"
               %sdl::sdl-touch-finger-event+~sdl-touch-finger-event)
              :void)

(cffi:defcfun ("SDL_UserEvent" %sdl::user-event) :void)

(cffi:defcfun ("~SDL_UserEvent" %sdl::sdl-user-event+~sdl-user-event)
              :void)

(cffi:defcfun ("SDL_WindowEvent" %sdl::window-event) :void)

(cffi:defcfun ("~SDL_WindowEvent"
               %sdl::sdl-window-event+~sdl-window-event)
              :void)

(cffi:defcfun ("SDL_WindowShapeMode" %sdl::window-shape-mode) :void)

(cffi:defcfun ("~SDL_WindowShapeMode"
               %sdl::sdl-window-shape-mode+~sdl-window-shape-mode)
              :void)

(cffi:defcfun ("SDL_version" %sdl::version) :void)

(cffi:defcfun ("~SDL_version" %sdl::sdl-version+~sdl-version) :void)
...
(cffi:defcfun ("SDL_Event" %sdl::event) :void)

(cffi:defcfun ("~SDL_Event" %sdl::sdl-event+~sdl-event) :void)

(cffi:defcfun ("SDL_HapticEffect" %sdl::haptic-effect) :void)

(cffi:defcfun ("~SDL_HapticEffect"
               %sdl::sdl-haptic-effect+~sdl-haptic-effect)
              :void)
...
(cffi:defcfun ("SDL_memcpy4" %sdl::memcpy4)
              (:pointer :void)
              (%sdl::dst (:pointer :void))
              (%sdl::src (:pointer :void))
              (%sdl::dwords %sdl::size-t))

(cffi:defcfun ("SDL_memset4" %sdl::memset4)
              :void
              (%sdl::dst (:pointer :void))
              (%sdl::val %sdl::uint32)
              (%sdl::dwords %sdl::size-t))
...
(export '%sdl::+hint-android-apk-expansion-patch-file-version+ "%SDL")
...
(export '%sdl::sdl-display-event+~sdl-display-event "%SDL")
...
(export '%sdl::sdl-mouse-wheel-event+~sdl-mouse-wheel-event "%SDL")
...
(export '%sdl::sdl-os-event+~sdl-os-event "%SDL")
...
(export '%sdl::sdl-haptic-left-right+~sdl-haptic-left-right "%SDL")
...
(export '%sdl::sdl-text-input-event+~sdl-text-input-event "%SDL")
...
(export '%sdl::sdl-palette+~sdl-palette "%SDL")
...
(export '%sdl::sdl-assert-data+~sdl-assert-data "%SDL")
...
(export '%sdl::+config-minimal-h-+ "%SDL")
...
(export '%sdl::sdl-sys-wm-event+~sdl-sys-wm-event "%SDL")
...
(export '%sdl::sdl-keyboard-event+~sdl-keyboard-event "%SDL")

(export '%sdl::+timers-disabled+ "%SDL")
...
(export '%sdl::sdl-controller-device-event+~sdl-controller-device-event
        "%SDL")
...
(export '%sdl::sdl-common-event+~sdl-common-event "%SDL")
...
(export '%sdl::sdl-controller-axis-event+~sdl-controller-axis-event
        "%SDL")

(export '%sdl::trunc "%SDL")

(export '%sdl::sdl-r-wops+~sdl-r-wops "%SDL")
...
(export '%sdl::sdl-finger+~sdl-finger "%SDL")
...
(export '%sdl::sdl-joy-hat-event+~sdl-joy-hat-event "%SDL")
...
(export '%sdl::+joystick-disabled+ "%SDL")
...
(export '%sdl::sdl-haptic-periodic+~sdl-haptic-periodic "%SDL")
...
(export '%sdl::sdl-touch-finger-event+~sdl-touch-finger-event "%SDL")
...
(export '%sdl::sdl-haptic-effect+~sdl-haptic-effect "%SDL")
...
(export '%sdl::sdl-rect+~sdl-rect "%SDL")
...
(export '%sdl::sdl-version+~sdl-version "%SDL")
...
(export '%sdl::+hint-window-frame-usable-while-cursor-hidden+ "%SDL")
...
(export '%sdl::sdl-haptic-direction+~sdl-haptic-direction "%SDL")

(export '%sdl::sdl-window-event+~sdl-window-event "%SDL")
...
(export '%sdl::sdl-dollar-gesture-event+~sdl-dollar-gesture-event
        "%SDL")
...
(export '%sdl::sdl-event+~sdl-event "%SDL")
...
(export '%sdl::sdl-controller-touchpad-event+~sdl-controller-touchpad-event
        "%SDL")
...
(export '%sdl::sdl-game-controller-button-bind+~sdl-game-controller-button-bind
        "%SDL")
...
(export '%sdl::sdl-audio-cvt+~sdl-audio-cvt "%SDL")
...
(export '%sdl::+haptic-disabled+ "%SDL")
...
(export '%sdl::sdl-surface+~sdl-surface "%SDL")
...
(export '%sdl::sdl-sensor-event+~sdl-sensor-event "%SDL")
...
(export '%sdl::sdl-haptic-condition+~sdl-haptic-condition "%SDL")
...
(export '%sdl::sdl-renderer-info+~sdl-renderer-info "%SDL")
...
(export '%sdl::sdl-joy-ball-event+~sdl-joy-ball-event "%SDL")
...
(export '%sdl::+filesystem-dummy+ "%SDL")
...
(export '%sdl::sdl-drop-event+~sdl-drop-event "%SDL")
...
(export '%sdl::sdl-sys-w-mmsg+~sdl-sys-w-mmsg "%SDL")
...
(export '%sdl::sdl-user-event+~sdl-user-event "%SDL")
...
(export '%sdl::sdl-f-point+~sdl-f-point "%SDL")
...
(export '%sdl::sdl-controller-sensor-event+~sdl-controller-sensor-event
        "%SDL")
...
(export '%sdl::sdl-multi-gesture-event+~sdl-multi-gesture-event
        "%SDL")
...
(export '%sdl::sdl-point+~sdl-point "%SDL")
...
(export '%sdl::+threads-disabled+ "%SDL")
...
(export '%sdl::sdl-joy-axis-event+~sdl-joy-axis-event "%SDL")
...
(export '%sdl::sdl-joy-device-event+~sdl-joy-device-event "%SDL")
...
(export '%sdl::sdl-haptic-constant+~sdl-haptic-constant "%SDL")
...
(export '%sdl::+hint-android-apk-expansion-main-file-version+ "%SDL")

(export '%sdl::joystick-is-haptic "%SDL")

(export '%sdl::+audiocvt-packed+ "%SDL")

(export '%sdl::sdl-mouse-button-event+~sdl-mouse-button-event "%SDL")

(export '%sdl::sdl-color+~sdl-color "%SDL")
...
(export '%sdl::sdl-audio-device-event+~sdl-audio-device-event "%SDL")
...
(export '%sdl::+sensor-disabled+ "%SDL")
...
(export '%sdl::sdl-quit-event+~sdl-quit-event "%SDL")
...
(export '%sdl::sdl-haptic-custom+~sdl-haptic-custom "%SDL")
...
(export '%sdl::sdl-sys-w-minfo+~sdl-sys-w-minfo "%SDL")
...
(export '%sdl::sdl-text-editing-event+~sdl-text-editing-event "%SDL")
...
(export '%sdl::sdl-joy-button-event+~sdl-joy-button-event "%SDL")
...
(export '%sdl::+loadso-disabled+ "%SDL")

(export '%sdl::sdl-mouse-motion-event+~sdl-mouse-motion-event "%SDL")
...
(export '%sdl::sdl-controller-button-event+~sdl-controller-button-event
        "%SDL")
...
(export '%sdl::sdl-f-rect+~sdl-f-rect "%SDL")

(export '%sdl::condition "%SDL")

(export '%sdl::sensor-get-device-instance-id "%SDL")

(export '%sdl::sdl-window-shape-mode+~sdl-window-shape-mode "%SDL")
...
(export '%sdl::sdl-pixel-format+~sdl-pixel-format "%SDL")
...
(export '%sdl::sdl-haptic-ramp+~sdl-haptic-ramp "%SDL")
...
(export '%sdl::sdl-locale+~sdl-locale "%SDL")

(export '%sdl::numbuttons "%SDL")

(export '%sdl::filter-events "%SDL")

(export '%sdl::sdl-audio-spec+~sdl-audio-spec "%SDL")

(export '%sdl::get-default-cursor "%SDL")

(export '%sdl::sdl-keysym+~sdl-keysym "%SDL")
...
(defmethod claw.generator.common:build-adapter ((claw.generator.common::wrapper-name
  ...
  (claw.generator.common::build-dynamic-adapter
    nil
    #P"/home/borodust/devel/repo/claw-sdl/src/lib/adapter.c"
    (list #P"/home/borodust/devel/repo/claw-sdl/src/"
          #P"/home/borodust/devel/repo/claw-sdl/src/lib/sdl/include/")
    (merge-pathnames
      (or claw.generator.common::target "adapter.so")
      #P"/home/borodust/devel/repo/claw-sdl/src/")
    :dependencies
    claw.generator.common::dependencies
    :compiler
    claw.generator.common::compiler
...
(defmethod claw.generator.common:initialize-adapter ((claw.generator.common::wrapper-name
                                                      (eql
                                                       ':claw-sdl/wrapper)))
  (declare (ignore claw.generator.common::wrapper-name))
  (claw.generator.common::%verify-adapter-initialization
    (cffi:foreign-funcall
      "__claw_claw_sdl_wrapper_loader_D77A52BD95F3BA6146BD0B16791B38379"
      :int)))
