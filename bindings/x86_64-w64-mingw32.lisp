...
(defparameter %sdl::+file+ "/tmp/tmpPS45EQFM-tmp.h")
...
(defparameter %sdl::+max-uint64+ 4294967295)
...
(cffi:defcstruct (%sdl::finger :size 16)
                 (%sdl::id %sdl::finger-id :offset 0)
                 (%sdl::x :float :offset 4)
                 (%sdl::y :float :offset 8)
                 (%sdl::pressure :float :offset 12))
...
(cffi:defcstruct (%sdl::sys-w-minfo :size 1))
...
(cffi:defcstruct (%sdl::sys-w-mmsg :size 1))
...
(cffi:defcstruct (%sdl::touch-finger-event :size 40)
                 (%sdl::type %sdl::uint32 :offset 0)
                 (%sdl::timestamp %sdl::uint32 :offset 4)
                 (%sdl::touch-id %sdl::touch-id :offset 8)
                 (%sdl::finger-id %sdl::finger-id :offset 12)
                 (%sdl::x :float :offset 16)
                 (%sdl::y :float :offset 20)
                 (%sdl::dx :float :offset 24)
                 (%sdl::dy :float :offset 28)
                 (%sdl::pressure :float :offset 32)
                 (%sdl::window-id %sdl::uint32 :offset 36))

(cffi:defctype %sdl::touch-finger-event
               (:struct %sdl::touch-finger-event))

(cffi:defcstruct (%sdl::multi-gesture-event :size 32)
                 (%sdl::type %sdl::uint32 :offset 0)
                 (%sdl::timestamp %sdl::uint32 :offset 4)
                 (%sdl::touch-id %sdl::touch-id :offset 8)
                 (%sdl::d-theta :float :offset 12)
                 (%sdl::d-dist :float :offset 16)
                 (%sdl::x :float :offset 20)
                 (%sdl::y :float :offset 24)
                 (%sdl::num-fingers %sdl::uint16 :offset 28)
                 (%sdl::padding %sdl::uint16 :offset 30))
...
(cffi:defcstruct (%sdl::dollar-gesture-event :size 32)
                 (%sdl::type %sdl::uint32 :offset 0)
                 (%sdl::timestamp %sdl::uint32 :offset 4)
                 (%sdl::touch-id %sdl::touch-id :offset 8)
                 (%sdl::gesture-id %sdl::gesture-id :offset 12)
                 (%sdl::num-fingers %sdl::uint32 :offset 16)
                 (%sdl::error :float :offset 20)
...
(cffi:defctype %sdl::compile-time-assert-sint64 :int)
...
(cffi:defctype %sdl::compile-time-assert-uint64 :int)
