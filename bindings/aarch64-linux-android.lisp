...
(defparameter %sdl::+audio-driver-aaudio+ 1)
...
(defparameter %sdl::+audio-driver-opensles+ 1)
...
(defparameter %sdl::+file+ "/tmp/tmpUDZMD33I-tmp.h")
...
(declaim (inline %sdl::android-send-message))

(cffi:defcfun ("SDL_AndroidSendMessage" %sdl::android-send-message)
              :int
              (%sdl::command %sdl::uint32)
              (%sdl::param :int))
...
(cffi:defcstruct (%sdl::|C:@S@SDL-SYS-W-MINFO@U@SDL-SYSWM.H@5897@S@SDL-SYSWM.H@9279|
                  :size 16)
                 (%sdl::window
...
(cffi:defcunion (%sdl::|C:@S@SDL-SYS-W-MINFO@U@SDL-SYSWM.H@5897|
                ...
                (%sdl::android
                 (:struct
                  %sdl::|C:@S@SDL-SYS-W-MINFO@U@SDL-SYSWM.H@5897@S@SDL-SYSWM.H@9279|))
...
(eval-when (:load-toplevel :compile-toplevel :execute)
  ...
  (export '%sdl::+audio-driver-opensles+ :%sdl)
  ...
  (export '%sdl::android-send-message :%sdl)
  ...
  (export '%sdl::+audio-driver-aaudio+ :%sdl)
  ...
  (export '%sdl::|C:@S@SDL-SYS-W-MINFO@U@SDL-SYSWM.H@5897@S@SDL-SYSWM.H@9279|
          :%sdl)
