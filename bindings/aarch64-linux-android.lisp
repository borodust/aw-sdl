...
(cffi:defcstruct (%sdl::|C:@S@SDL-R-WOPS@U@SDL-RWOPS.H@3176@S@SDL-RWOPS.H@3221|
                  :size 8)
                 (%sdl::asset (:pointer :void) :offset 0))
...
(cffi:defctype %sdl::%%off64-t :long-long)
...
(cffi:defctype %sdl::egl-surface (:pointer :void))

(cffi:defcstruct (%sdl::|C:@S@SDL-SYS-W-MINFO@U@SDL-SYSWM.H@5693@S@SDL-SYSWM.H@8374|
                  :size 16)
                 (%sdl::window (:pointer %sdl::a-native-window)
                  :offset 0)
...
(cffi:defcstruct (%sdl::%%va-list :size 32)
                 (%sdl::%%stack (:pointer :void) :offset 0)
                 (%sdl::%%gr-top (:pointer :void) :offset 8)
                 (%sdl::%%vr-top (:pointer :void) :offset 16)
                 (%sdl::%%gr-offs :int :offset 24)
                 (%sdl::%%vr-offs :int :offset 28))

(cffi:defctype %sdl::va-list (:struct %sdl::%%va-list))
