...
(defparameter %sdl::+file+ "/tmp/tmpJWS3HIKS-tmp.h")
...
(defparameter %sdl::+bus-adraln+ 1)

(defparameter %sdl::+bus-adrerr+ 2)

(defparameter %sdl::+bus-objerr+ 3)

(defparameter %sdl::+bus-mceerr-ar+ 4)

(defparameter %sdl::+bus-mceerr-ao+ 5)

(defparameter %sdl::+cld-exited+ 1)

(defparameter %sdl::+cld-killed+ 2)

(defparameter %sdl::+cld-dumped+ 3)

(defparameter %sdl::+cld-trapped+ 4)

(defparameter %sdl::+cld-stopped+ 5)

(defparameter %sdl::+cld-continued+ 6)

(defparameter %sdl::+fpe-intdiv+ 1)

(defparameter %sdl::+fpe-intovf+ 2)

(defparameter %sdl::+fpe-fltdiv+ 3)

(defparameter %sdl::+fpe-fltovf+ 4)

(defparameter %sdl::+fpe-fltund+ 5)

(defparameter %sdl::+fpe-fltres+ 6)

(defparameter %sdl::+fpe-fltinv+ 7)

(defparameter %sdl::+fpe-fltsub+ 8)

(defparameter %sdl::+fpe-fltunk+ 14)

(defparameter %sdl::+fpe-condtrap+ 15)
...
(defparameter %sdl::+ill-illopc+ 1)

(defparameter %sdl::+ill-illopn+ 2)

(defparameter %sdl::+ill-illadr+ 3)

(defparameter %sdl::+ill-illtrp+ 4)

(defparameter %sdl::+ill-prvopc+ 5)

(defparameter %sdl::+ill-prvreg+ 6)

(defparameter %sdl::+ill-coproc+ 7)

(defparameter %sdl::+ill-badstk+ 8)

(defparameter %sdl::+ill-badiaddr+ 9)

(defparameter %sdl::+poll-in+ 1)

(defparameter %sdl::+poll-out+ 2)

(defparameter %sdl::+poll-msg+ 3)

(defparameter %sdl::+poll-err+ 4)

(defparameter %sdl::+poll-pri+ 5)

(defparameter %sdl::+poll-hup+ 6)

(defparameter %sdl::+segv-maperr+ 1)

(defparameter %sdl::+segv-accerr+ 2)

(defparameter %sdl::+segv-bnderr+ 3)

(defparameter %sdl::+segv-pkuerr+ 4)

(defparameter %sdl::+segv-accadi+ 5)

(defparameter %sdl::+segv-adiderr+ 6)

(defparameter %sdl::+segv-adiperr+ 7)

(defparameter %sdl::+segv-mteaerr+ 8)

(defparameter %sdl::+segv-mteserr+ 9)

(defparameter %sdl::+sigev-signal+ 0)

(defparameter %sdl::+sigev-none+ 1)

(defparameter %sdl::+sigev-thread+ 2)

(defparameter %sdl::+sigev-thread-id+ 4)

(defparameter %sdl::+si-asyncnl+ -60)

(defparameter %sdl::+si-dethread+ -7)

(defparameter %sdl::+si-tkill+ -6)

(defparameter %sdl::+si-sigio+ -5)

(defparameter %sdl::+si-asyncio+ -4)

(defparameter %sdl::+si-mesgq+ -3)

(defparameter %sdl::+si-timer+ -2)

(defparameter %sdl::+si-queue+ -1)

(defparameter %sdl::+si-user+ 0)

(defparameter %sdl::+si-kernel+ 128)

(defparameter %sdl::+ss-onstack+ 1)

(defparameter %sdl::+ss-disable+ 2)
...
(cffi:defcstruct (%sdl::|C:@S@SDL-R-WOPS@U@SDL-RWOPS.H@3255@S@SDL-RWOPS.H@3300|
                  :size 8)
...
(cffi:defcunion (%sdl::|C:@S@SDL-R-WOPS@U@SDL-RWOPS.H@3255| :size 24)
                (%sdl::androidio
                 (:struct
                  %sdl::|C:@S@SDL-R-WOPS@U@SDL-RWOPS.H@3255@S@SDL-RWOPS.H@3300|))
                (%sdl::stdio
                 (:struct
...
(declaim (inline %sdl::android-show-toast))

(cffi:defcfun ("SDL_AndroidShowToast" %sdl::android-show-toast)
              :int
...
(cffi:defcstruct (%sdl::|C:@S@SDL-SYS-W-MINFO@U@SDL-SYSWM.H@5779@S@SDL-SYSWM.H@8898|
                  :size 16)
                 (%sdl::window
...
(cffi:defcunion (%sdl::|C:@S@SDL-SYS-W-MINFO@U@SDL-SYSWM.H@5779|
                ...
                (%sdl::android
                 (:struct
                  %sdl::|C:@S@SDL-SYS-W-MINFO@U@SDL-SYSWM.H@5779@S@SDL-SYSWM.H@8898|))
...
(cffi:defcstruct (%sdl::std+--va-list :size 32)
                 (%sdl::%%stack (claw-utils:claw-pointer :void)
                  :offset 0)
                 (%sdl::%%gr-top (claw-utils:claw-pointer :void)
                  :offset 8)
                 (%sdl::%%vr-top (claw-utils:claw-pointer :void)
                  :offset 16)
...
(eval-when (:load-toplevel :compile-toplevel :execute)
  ...
  (export '%sdl::x :%sdl)
  (export '%sdl::fabs :%sdl)
  (export '%sdl::|C:@S@SDL-SYS-W-MINFO@U@SDL-SYSWM.H@5779@S@SDL-SYSWM.H@8898|
          :%sdl)
  ...
  (export '%sdl::+poll-in+ :%sdl)
  (export '%sdl::blit :%sdl)
  (export '%sdl::sem-post :%sdl)
  (export '%sdl::+sigev-signal+ :%sdl)
  ...
  (export '%sdl::+fpe-condtrap+ :%sdl)
  (export '%sdl::+segv-mteserr+ :%sdl)
  (export '%sdl::close-audio :%sdl)
  (export '%sdl::+hint-joystick-rawinput-correlate-xinput+ :%sdl)
  (export '%sdl::save-bmp-rw :%sdl)
  (export '%sdl::|C:@S@SDL-R-WOPS@U@SDL-RWOPS.H@3255@S@SDL-RWOPS.H@3300|
          :%sdl)
  ...
  (export '%sdl::+fpe-fltund+ :%sdl)
  (export '%sdl::jball :%sdl)
  (export '%sdl::+segv-adiperr+ :%sdl)
  (export '%sdl::+ss-onstack+ :%sdl)
  (export '%sdl::tanf :%sdl)
  ...
  (export '%sdl::+cld-trapped+ :%sdl)
  (export '%sdl::r-wclose :%sdl)
  (export '%sdl::android-show-toast :%sdl)
  (export '%sdl::+fpe-intovf+ :%sdl)
  (export '%sdl::+file+ :%sdl)
  ...
  (export '%sdl::+sigev-thread-id+ :%sdl)
  ...
  (export '%sdl::+bus-objerr+ :%sdl)
  (export '%sdl::wchar-t :%sdl)
  (export '%sdl::+segv-accadi+ :%sdl)
  ...
  (export '%sdl::+fpe-fltsub+ :%sdl)
  (export '%sdl::+poll-out+ :%sdl)
  ...
  (export '%sdl::+si-kernel+ :%sdl)
  (export '%sdl::+segv-bnderr+ :%sdl)
  (export '%sdl::sinf :%sdl)
